...
class PokapiCacheFeature extends PokapiBaseFeature
{
    ...
    private function _through(PokapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
