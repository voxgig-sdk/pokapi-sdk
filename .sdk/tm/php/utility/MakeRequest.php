...
// Pokapi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PokapiMakeRequest
{
    public static function call(PokapiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PokapiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PokapiResponse($fetched);
        } else {
