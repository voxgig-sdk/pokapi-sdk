...
class PokapiTimeoutFeature extends PokapiBaseFeature
{
    ...
    private function _with_timeout(PokapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PokapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
