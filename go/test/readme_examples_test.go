...
const testSeed = `map[string]any{"entity": map[string]any{"ability": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "paginated_resource_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pokemon": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pokemon_species": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "type": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
