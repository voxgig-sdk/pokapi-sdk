...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/pokapi` | `npm install @voxgig-sdk/pokapi` |
| Python | `voxgig-sdk-pokapi` | `pip install voxgig-sdk-pokapi` |
| PHP | `voxgig-sdk/pokapi` | `composer require voxgig-sdk/pokapi` |
| Golang | `github.com/voxgig-sdk/pokapi-sdk/go` | `go get github.com/voxgig-sdk/pokapi-sdk/go` |
| Ruby | `voxgig-sdk-pokapi` | `gem install voxgig-sdk-pokapi` |
| Lua | `voxgig-sdk-pokapi` | `luarocks install voxgig-sdk-pokapi` |
