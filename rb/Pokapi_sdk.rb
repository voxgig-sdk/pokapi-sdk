...
class PokapiSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = PokapiHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = PokapiHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, PokapiFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def prepare(fetchargs = {})
    ...
    params = PokapiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = PokapiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = PokapiHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
