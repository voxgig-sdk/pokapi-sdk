...
describe("AbilityDirect", function()
  it("should direct-load-ability", function()
    local setup = ability_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ability", setup.live and "live" or "unit")
...
function ability_direct_setup(mockres)
