...
func registerSDKWords(r *eng.Registry, client *sdk.PokapiSDK) {
...
func runOp(client *sdk.PokapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
