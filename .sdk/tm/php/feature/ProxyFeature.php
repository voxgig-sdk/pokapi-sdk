...
class PokapiProxyFeature extends PokapiBaseFeature
{
    ...
    public function init(PokapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PokapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
