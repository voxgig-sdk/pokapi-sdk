...
from projectname_sdk import PokapiSDK
from core.spec import PokapiSpec
from core.result import PokapiResult
from core.response import PokapiResponse
from core.operation import PokapiOperation
from core.error import PokapiError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = PokapiSDK.test(None, None)
        ...
        class TestInitFeature(PokapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PokapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PokapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PokapiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PokapiSDK.test(None, setup_opts)
