...
// Pokapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PokapiSDK::test)
...
{
    private const SDK_CLASS = 'PokapiSDK';
    ...
    private const SDK_BASE = 'pokapi_sdk';
