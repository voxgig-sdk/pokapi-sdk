-- Pokapi SDK PaginatedResourceList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PaginatedResourceListEntity = {}
PaginatedResourceListEntity.__index = PaginatedResourceListEntity


function PaginatedResourceListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaginatedResourceListEntity)
  self._name = "paginated_resource_list"
  self._client = client
...
function PaginatedResourceListEntity:get_name()
  return self._name
end


function PaginatedResourceListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaginatedResourceListEntity.new(self._client, opts)
end


function PaginatedResourceListEntity:data_set(args)
  if args ~= nil then
...
function PaginatedResourceListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaginatedResourceListEntity:match_set(args)
  if args ~= nil then
...
function PaginatedResourceListEntity:match_get()
...
function PaginatedResourceListEntity:stream(action, args, callopts)
...
function PaginatedResourceListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PaginatedResourceListEntity
