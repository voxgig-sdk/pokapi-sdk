...
{
    private static function utility(): PokapiUtility
    {
        return new PokapiUtility();
    }
    ...
    private static function ctx(array $over = []): PokapiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PokapiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PokapiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PokapiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PokapiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PokapiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PokapiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PokapiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PokapiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PokapiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PokapiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PokapiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PokapiResponse([]),
            'result' => new PokapiResult([]),
        ]);
        [, $err] = PokapiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PokapiSpec(['step' => 's']),
            'response' => new PokapiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PokapiResult([]),
        ]);
        [, $err] = PokapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PokapiSpec(['step' => 's']),
            'response' => new PokapiResponse(self::resp(200, ['v' => 1])),
            'result' => new PokapiResult([]),
        ]);
        [, $err] = PokapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PokapiSpec(['step' => 's']),
            'response' => new PokapiResponse(self::resp(200, ['v' => 2])),
            'result' => new PokapiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PokapiMakeResponse::call($ctx);
    ...
    {
        $preset = new PokapiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PokapiSpec([]),
            'response' => new PokapiResponse([]),
            'result' => new PokapiResult([]),
        ...
        [$got, $err] = PokapiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PokapiResult([])]);
        [, $err] = PokapiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PokapiSpec([]), 'result' => null]);
        [, $err] = PokapiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PokapiSpec(['step' => 's']),
            'result' => new PokapiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PokapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PokapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PokapiSpec(['step' => 's']),
            'result' => new PokapiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PokapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PokapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PokapiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PokapiSpec([]),
            'result' => new PokapiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PokapiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PokapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PokapiError('boom', 'boom');
        $utility->fetcher = function (PokapiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PokapiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PokapiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PokapiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PokapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PokapiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PokapiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PokapiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PokapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PokapiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PokapiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PokapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PokapiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PokapiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PokapiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PokapiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PokapiResult(['ok' => false])]);
        $this->expectException(PokapiError::class);
        PokapiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PokapiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PokapiMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PokapiBaseFeature();
        $b = new PokapiBaseFeature();
        PokapiFeatureAdd::call($ctx, $a);
        PokapiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PokapiBaseFeature
    {
        $f = new PokapiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PokapiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PokapiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PokapiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PokapiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PokapiResponse(['headers' => null]),
            'result' => new PokapiResult([]),
        ]);
        PokapiResultHeaders::call($ctx);
