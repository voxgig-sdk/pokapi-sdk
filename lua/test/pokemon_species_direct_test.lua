...
describe("PokemonSpeciesDirect", function()
  it("should direct-load-pokemon_species", function()
    local setup = pokemon_species_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-pokemon_species", setup.live and "live" or "unit")
