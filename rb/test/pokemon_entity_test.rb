...
class PokemonEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set POKAPI_TEST_POKEMON_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def pokemon_basic_setup(extra)
  ...
  entid_env_raw = ENV["POKAPI_TEST_POKEMON_ENTID"]
