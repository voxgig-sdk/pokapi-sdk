...
// Pokapi SDK clienttrack feature
...
class PokapiClienttrackFeature extends PokapiBaseFeature
{
    ...
    public function PostConstruct(PokapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pokapi-SDK';
