...
class PaginatedResourceListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "paginated_resource_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedResourceListEntity($this->_client, $opts);
    }

    /**
     * @param PaginatedResourceList|array $args PaginatedResourceList data (assoc-array) to store.
     */
    ...
    /**
     * @return PaginatedResourceList|array The current PaginatedResourceList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaginatedResourceList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaginatedResourceList fields).
     */
