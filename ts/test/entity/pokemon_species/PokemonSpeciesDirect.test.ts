...
describe('PokemonSpeciesDirect', async () => {
  ...
  test('direct-load-pokemon_species', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-pokemon_species', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POKAPI_TEST_POKEMON_SPECIES_ENTID']
