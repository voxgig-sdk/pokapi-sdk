...
class PokapiRatelimitFeature extends PokapiBaseFeature
{
    ...
    private function _acquire(PokapiContext $ctx): void
    {
    ...
    private function _track(PokapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
