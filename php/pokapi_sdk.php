...
class PokapiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = PokapiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = PokapiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, PokapiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return PokapiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = PokapiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = PokapiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = PokapiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    public function direct(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = PokapiHelpers::to_int(Struct::getprop($fetched, "status"));
