...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ability | paginated_resource_list | pokemon | pokemon_species | type"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PokapiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "pokapi_list",
		Description: "List records from Pokapi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "pokapi_load",
		Description: "Load a single record from Pokapi. " +
...
func runOp(client *sdk.PokapiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PokapiSDK, name string) (sdk.PokapiEntity, error) {
	switch strings.ToLower(name) {
	case "ability":
		return client.Ability(nil), nil
	case "paginated_resource_list":
		return client.PaginatedResourceList(nil), nil
	case "pokemon":
		return client.Pokemon(nil), nil
	case "pokemon_species":
		return client.PokemonSpecies(nil), nil
	case "type":
