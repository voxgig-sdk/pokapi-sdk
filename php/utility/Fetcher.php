...
class PokapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PokapiSDK/1.0)';
    ...
    public static function call(PokapiContext $ctx, string $fullurl, array $fetchdef): array
    {
