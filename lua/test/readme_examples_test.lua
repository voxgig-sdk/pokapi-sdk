...
-- data to return.
local TEST_SEED = '{ entity = { ["ability"] = { ["test01"] = { id = "test01" } }, ["paginated_resource_list"] = { ["test01"] = { id = "test01" } }, ["pokemon"] = { ["test01"] = { id = "test01" } }, ["pokemon_species"] = { ["test01"] = { id = "test01" } }, ["type"] = { ["test01"] = { id = "test01" } } } }'
