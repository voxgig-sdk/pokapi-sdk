...
PokapiSDK._make_feature = _make_feature


function PokapiSDK.new(options)
  local self = setmetatable({}, PokapiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function PokapiSDK:options_map()
...
function PokapiSDK:get_utility()
  return Utility.copy(self._utility)
end


function PokapiSDK:get_root_ctx()
  return self._rootctx
end


function PokapiSDK:prepare(fetchargs)
...
function PokapiSDK:direct(fetchargs)
  local utility = self._utility
...
function PokapiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = PokapiSDK.new(sdkopts)
  sdk.mode = "test"
