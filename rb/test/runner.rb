...
module PokapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("POKAPI_TEST_LIVE")
    override = getenv("POKAPI_TEST_OVERRIDE")
    ...
    explain = getenv("POKAPI_TEST_EXPLAIN")
    m["POKAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PokapiTestRunner
Helpers = PokapiHelpers
Vs = VoxgigStruct
