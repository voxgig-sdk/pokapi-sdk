...
from core.control import PokapiControl
...
class PokapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, PokapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PokapiError(code, msg, self)
