...
// Pokapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PokapiTestFeature extends PokapiBaseFeature
{
    ...
    public function init(PokapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PokapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PokapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PokapiContext $ctx, $op, $args): array
    {
