...
class PokapiTestRunner
{
    ...
    {
        $live = self::getenv('POKAPI_TEST_LIVE');
        $override = self::getenv('POKAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('POKAPI_TEST_EXPLAIN');
...
class_alias('PokapiTestRunner', 'Runner');
class_alias('PokapiHelpers', 'Helpers');
