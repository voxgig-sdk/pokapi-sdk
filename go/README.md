...
The Golang SDK for the Pokapi API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/pokapi-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/pokapi-sdk=../path/to/github.com/voxgig-sdk/pokapi-sdk
```
...
```
github.com/voxgig-sdk/pokapi-sdk/
...
The root package (`github.com/voxgig-sdk/pokapi-sdk`) re-exports everything needed
