...
class AbilityDirectTest extends TestCase
{
    public function test_direct_load_ability(): void
    {
        $setup = ability_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ability", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
