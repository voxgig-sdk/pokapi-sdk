...
class PokapiNetsimFeature extends PokapiBaseFeature
{
    ...
    private function _simulate(PokapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PokapiContext $ctx, array $applied): void
    {
        $client = $this->client;
