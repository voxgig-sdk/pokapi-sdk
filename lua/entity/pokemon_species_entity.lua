...
local PokemonSpeciesEntity = {}
PokemonSpeciesEntity.__index = PokemonSpeciesEntity


function PokemonSpeciesEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PokemonSpeciesEntity)
  self._name = "pokemon_species"
  self._client = client
...
function PokemonSpeciesEntity:get_name()
  return self._name
end


function PokemonSpeciesEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PokemonSpeciesEntity.new(self._client, opts)
end


function PokemonSpeciesEntity:data_set(args)
  if args ~= nil then
...
function PokemonSpeciesEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PokemonSpeciesEntity:match_set(args)
  if args ~= nil then
...
function PokemonSpeciesEntity:match_get()
...
function PokemonSpeciesEntity:stream(action, args, callopts)
...
function PokemonSpeciesEntity:_run_op(ctx, post_done)
  local utility = self._utility
