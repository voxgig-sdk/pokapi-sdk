...
class PokapiStreamingFeature extends PokapiBaseFeature
{
    ...
    private function _iterate(PokapiResult $result): \Generator
    {
    ...
    private function _streamable(PokapiContext $ctx): bool
    {
