...
class PokemonEntity
  ...
  #
  # @param reqmatch [PokemonLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Pokemon.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Pokemon, Hash] the loaded Pokemon; raises PokapiError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Pokemon>, Array] the matching Pokemon items; raises PokapiError on failure
