...
class PokemonSpeciesEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PokemonSpeciesEntity(self._client, opts)
    ...
    def data_get(self) -> PokemonSpecies:
    ...
    def match_get(self) -> PokemonSpecies:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PokemonSpecies:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PokemonSpecies().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
