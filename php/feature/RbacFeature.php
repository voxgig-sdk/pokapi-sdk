...
class PokapiRbacFeature extends PokapiBaseFeature
{
    ...
    private function _required(PokapiContext $ctx): ?string
    {
    ...
    private function _reject(PokapiContext $ctx, string $required): void
    {
    ...
    private function _track(PokapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
