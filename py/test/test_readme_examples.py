# Pokapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PokapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PokapiSDK(...) and PokapiSDK.test(...) become
#      PokapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pokapi_sdk"
_SDK_CLASS = "PokapiSDK"
