...
describe('AbilityDirect', async () => {
  ...
  test('direct-load-ability', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-ability', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POKAPI_TEST_ABILITY_ENTID']
